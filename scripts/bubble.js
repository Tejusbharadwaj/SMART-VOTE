...
var config1 = liquidFillGaugeDefaultSettings();
    ...
    config1.circleColor = "#fill";
    config1.textColor = "#808015";
...
function loadLiquidFillGauge(elementId, value, config,image) {
    ...
    var gaugeGroup = gauge.append("g")
        ...
        .attr("xlink:href", image) 
         ...
         // .attr('transform','translate('+(radius-230)+','+(radius-100)+')')
          .attr('transform','translate('+locationX-1000+','+locationY-1000+')')
